...
public class QAccount extends EntityPathBase<Account> {
    ...
    private static final long serialVersionUID = -1052365276L;
    ...
    public final ListPath<ConsumeHistory, QConsumeHistory> consumeHistoryList = this.<ConsumeHistory, QConsumeHistory>createList("consumeHistoryList", ConsumeHistory.class, QConsumeHistory.class, PathInits.DIRECT2);
