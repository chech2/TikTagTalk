    ...
    return (
        <div className="start-page-container">
            <div className="start-logo-container">
                ...
                <img src={logo2} className="animate__animated animate__fadeInLeft start-logo"></img>
                <img src={logo1} className="animate__animated animate__fadeInDown start-logo"></img>
            </div>
