...
function ExchangePage(props) {
    ...
    const calculatedValue = parseFloat(inputValue) * Data.exchangeRate;
    const handleBuySkin = ()=>{
        console.log()
    }
    ...
    return (
        ...
        <div className='exchange-coin-point'>
            ...
            min="1"/>
            <img className='exchange-responsive-image2' src="./Icon/Coin.png" alt="" />=
                <div style={{color:"000000"}} className='point-output'>{isNaN(calculatedValue) ? Data : calculatedValue}</div>
            <img className='exchange-responsive-image2' src="./Icon/포인트 아이콘.png" alt="" />
